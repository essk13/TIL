...
change_upper = dict(zip(lower_alpha, upper_alpha))

input_Headline = input()
input_Headline = list(input_Headline)
cnt = len(input_Headline)
for index in range(cnt):
    if input_Headline[index] in list(lower_alpha):
        input_Headline[index] = change_upper[input_Headline[index]]
    else:
        pass

print(''.join(input_Headline))

# or
# print(input_Headline.upper())